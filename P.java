 ...
 */
    ...
    public P(int bitLengthVal, int certainty) {
    ...
    public static void main(String[] args) {
        ...
        //创建两个大整数m1,m2:
        BigInteger m1 = new BigInteger("11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111" );
        ...
        System.out.println("加密程序运行时间： "+(endTime2 - startTime2)+"ms");
