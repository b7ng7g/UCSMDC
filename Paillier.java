...
public class Paillier {
    ...
    public static void main(String[] args) {
       ...
       // long startTime1=System.currentTimeMillis();
        ...
        System.out.println("生成密钥运行时间： "+(endTime1 - startTime1)+"ns");
        ...
        System.out.println("加密程序运行时间： "+(endTime2 - startTime2)+"ns");
        ...
        System.out.println("解密程序运行时间： "+(endTime3 - startTime3)+"ns");
    }
}
